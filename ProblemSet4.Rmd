...
```
```{r include=TRUE}
dif_in_dif_treated <- melt(results_treated, measure = 6:10)
dif_in_dif_treated[,7] <- 
sapply(dif_in_dif_treated[,7], function(x) as.numeric(x))
...
dif_in_dif_controled <- melt(results_control, measure = 6:10)
dif_in_dif_controled[,7] <- 
sapply(dif_in_dif_controled[,7], function(x) as.numeric(x))

dif_in_dif_controled %>% 
  ggplot(aes(x = variable,
             y = value
             #color = state
             )) +
...
```
```{r include=TRUE}
dif_in_dif_treated <- mutate(dif_in_dif_treated, sig_program = "yes")
dif_in_dif_controled <- mutate(dif_in_dif_controled, sig_program = "no")

dif_in_dif_both <- rbind(dif_in_dif_controled, dif_in_dif_treated)
